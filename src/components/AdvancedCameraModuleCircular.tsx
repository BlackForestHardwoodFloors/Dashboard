...
import { CircularContouredButton } from './CircularContouredButton';
import { MaskRing } from './MaskRing';
import { CameraShutter3DAbsolute } from './CameraShutter3DAbsolute';

interface AdvancedCameraModuleCircularProps {
  onCapturePhoto: () => void;
  onWorkOrder: () => void;
  onChangeOrder: () => void;
  onStainSignOff: () => void;
...
export function AdvancedCameraModuleCircular({
  onCapturePhoto,
  onWorkOrder,
  onChangeOrder,
  onStainSignOff,
  ...
  onMessage,
  onNotes,
}: AdvancedCameraModuleCircularProps) {
  return (
    <CameraModuleFrame>
